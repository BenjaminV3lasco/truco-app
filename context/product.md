...
- La variante “Puntas” puede activarse o desactivarse desde Ajustes. Solo afecta partidos 3vs3: comienzan en Redonda y, al finalizar una mano donde un equipo llegó a 5, alternan Puntas/Redonda hasta los 24 puntos. El usuario configura entre 5 y 60 segundos sin cambios para dar una mano por terminada. El tipo de ronda actual se muestra en el encabezado del anotador con una animación breve al cambiar.
- Ajustes es una pantalla independiente, accesible desde el encabezado y el menú principal. Sus preferencias son persistentes e incluyen variantes, sonidos, duración de la mano, puntaje predeterminado a 15 o 30 y representación mediante fósforos o porotos. Los cambios de vista usan transiciones breves, los controles tienen microinteracciones y los botones reproducen un toque grave inspirado en una cuerda de guitarra. La decoración evita emojis y utiliza iconografía lineal propia.
